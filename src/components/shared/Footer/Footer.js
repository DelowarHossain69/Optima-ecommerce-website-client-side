    ...
    <div>
      <footer class="footer p-10 bg-base-200 text-base-content">
        ...
        <div>
          ...
          <a class="link link-hover">BD Cricket Live</a>
        </div>
        <div>
      ...
      <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <div class="items-center grid-flow-col">
          <img src="https://i.ibb.co/cJnq2QN/optimasupermarket-responsive-prestashop-theme-logo-1571902912.png" className=" w-20" alt="" />
          <p>
            Optima Ltd. <br />
            Providing best product since 2002
          </p>
        </div>
